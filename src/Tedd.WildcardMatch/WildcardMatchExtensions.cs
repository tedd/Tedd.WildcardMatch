...
public static class WildcardMatchExtensions
{
    ...
    public static bool IsWildcardMatch(this string input, string wildcard, bool ignoreCase = false) => Regex.IsMatch(input, InternalUtils.StringToWildcard(wildcard) ?? string.Empty, ignoreCase ? RegexOptions.IgnoreCase : RegexOptions.None);
}
